...
public class JournalBeanReportes implements Serializable {
  ...
  private double impSoles;
  private double impEuros;
   ...
   */
  public double getImpTransaccionAmount() {
   ...
   */
  public void setImpTransaccionAmount(double impTransaccionAmount) {
   ...
   *          the impSoles to set
   */
  public void setImpSoles(double impSoles) {
   ...
   *          the impEuros to set
   */
  public void setImpEuros(double impEuros) {
