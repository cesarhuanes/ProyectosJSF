...
public interface DireccionPropietarioVehiculoDirectoMapper {

  final String UPDATE_BY_PLACA = "update DIRECCION_PROPIETARIO_VEHICULO  set VERSION = #{direccionPropietarioVehiculo.version}, "
      + "DIRECCION = #{direccionPropietarioVehiculo.direccion} where PLACA = #{direccionPropietarioVehiculo.placa}";
