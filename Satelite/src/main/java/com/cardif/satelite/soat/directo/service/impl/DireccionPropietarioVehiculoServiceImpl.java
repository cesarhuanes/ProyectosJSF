...
import com.cardif.satelite.soat.directo.dao.DireccionPropietarioVehiculoDirectoMapper;
...
@Service("direccionPropietarioVehiculoServiceDirecto")
public class DireccionPropietarioVehiculoServiceImpl implements DireccionPropietarioVehiculoServiceDirecto {

  public static final Logger log = Logger.getLogger(DireccionPropietarioVehiculoServiceImpl.class);

  @Autowired
  DireccionPropietarioVehiculoDirectoMapper direccionPropietarioVehiculoMapper;
