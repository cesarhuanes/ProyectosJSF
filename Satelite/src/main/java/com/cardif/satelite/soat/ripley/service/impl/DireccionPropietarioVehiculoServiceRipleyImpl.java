...
import com.cardif.satelite.soat.ripley.dao.DireccionPropietarioVehiculoRipleyMapper;
import com.cardif.satelite.soat.ripley.service.DireccionPropietarioVehiculoServiceRipley;

@Service("direccionPropietarioVehiculoServiceRipley")
public class DireccionPropietarioVehiculoServiceRipleyImpl implements DireccionPropietarioVehiculoServiceRipley {

  public static final Logger log = Logger.getLogger(DireccionPropietarioVehiculoServiceRipleyImpl.class);

  @Autowired
  DireccionPropietarioVehiculoRipleyMapper direccionPropietarioVehiculoMapper;
