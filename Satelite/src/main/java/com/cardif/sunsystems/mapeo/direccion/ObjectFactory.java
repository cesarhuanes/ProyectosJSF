...
/**
 * This object contains factory methods for each Java content interface and Java element interface generated in the com.address package.
 * <p>
...
public class ObjectFactory {
  ...
  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.address
   * 
   */
  ...
  /**
   * Create an instance of {@link SSC.Payload.Address }
   * 
   */
  public SSC.Payload.Address createSSCPayloadAddress() {
    return new SSC.Payload.Address();
  }
